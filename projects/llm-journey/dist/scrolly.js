...
function ScrollyApp() {
  ...
  const [refs, {
    active,
    progress
  }] = useScrollProgress(SCENES.length);
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("header", {
  ...
  }, L.appTitle), /*#__PURE__*/React.createElement("div", {
    className: "lj-rail",
    style: {
      display: 'flex',
      gap: 6,
    ...
    "data-testid": "rail"
  }, L.stops.map((s, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
  ...
  }, L.langBtn)), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 'var(--hdr)'
    }
  }), SCENES.map((Scene, i) => /*#__PURE__*/React.createElement("section", {
    key: i,
    ref: el => refs.current[i] = el,
    "data-scene": i,
    style: {
      minHeight: SCROLL_DRIVEN.includes(i) ? '220vh' : '130vh',
      position: 'relative',
    ...
    style: {
      position: 'sticky',
      top: 'var(--hdr)',
      minHeight: 'calc(100vh - var(--hdr))',
      display: 'flex',
      alignItems: 'center',
      opacity: i === active || Math.abs(i - active) <= 1 ? 1 : .35,
...
ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(ScrollyApp, null));